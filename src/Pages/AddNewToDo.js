...
let AddNewToDo=()=>{
    ...
    let submitHandler=(e)=>{
        ...
        let todo={id:newIndex,title:enteredTitle,
            deadline:{day:Number(enteredDeadline.slice(8,10)),month:Number(enteredDeadline.slice(5,7)),year:Number(enteredDeadline.slice(0,4)),hour:Number(enteredDeadline.slice(11,13))},
